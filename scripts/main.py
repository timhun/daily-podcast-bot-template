...
def generate_script(data):
    prompt = f"""
    為《大叔說財經科技投資》生成一個12分鐘的中文Podcast腳本，語氣為親切的台灣發音中年大叔風格，語速為正常1.3倍，美股代碼及指數都英文發音，包含以下內容：
    ...
    5. 最新AI技術或美國總體經濟新聞，關稅最新狀況（模擬：輝達發布Rubin平台，效能提升35%）。
    6. 每日投資金句：市場如人生，穩中求進才能走得遠。
    開場：早安，歡迎收聽《大叔說財經科技投資》！我是你們的老朋友，今天又是充滿機會的一天！準備好你的咖啡，咱們來看看昨晚美股的表現，還有那些值得關注的市場動態！
